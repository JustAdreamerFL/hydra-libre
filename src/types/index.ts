...
/**
 * The result of a profile-folder operation. Profile sync is deliberately
 * independent from Hydra Cloud: the folder may be on a local disk or managed
 * by any file-sync provider selected by the user.
 */
