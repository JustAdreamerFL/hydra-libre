...
contextBridge.exposeInMainWorld("electron", {
  ...
  /* Free profile-folder sync */
  profileSync: {
    getStatus: () =>
      ipcRenderer.invoke("profileSyncGetStatus") as Promise<ProfileSyncStatus>,
    sync: () =>
      ipcRenderer.invoke("profileSync") as Promise<ProfileSyncSummary>,
    restore: () =>
      ipcRenderer.invoke("profileSyncRestore") as Promise<ProfileSyncSummary>,
    export: () =>
      ipcRenderer.invoke("profileSyncExport") as Promise<ProfileSyncSummary>,
  },
