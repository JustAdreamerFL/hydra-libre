    ...
    <div className="achievements-content__achievements-list">
      ...
      >
        ...
        {otherUser && (
          ...
          >
            <div className="achievements-content__achievements-list__section__table-header__container achievements-content__achievements-list__section__table-header__container--comparison">
              <div></div>
