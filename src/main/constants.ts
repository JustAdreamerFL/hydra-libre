...
/**
 * The default provider intentionally points at the user-managed folder.
 *
 * Hydra Cloud remains available for people who want the hosted service, but
 * the launcher must not silently require a subscription for save backups.
 * A folder can be local or a folder managed by Dropbox, OneDrive, Syncthing,
 * Nextcloud, etc.
 */
export const DEFAULT_BACKUP_PROVIDER = "local" as const;
